...
const CoONasRikaji = (props) => {
	...
	const paginationMobile = useRef(null)
		...
		<div className={styles.CoONasRikajiSection}>
			<div className='container narrow text-center'>
				...
				<p className={styles.perex}>
					I ten slavnej českej šéfík z televize, co zatopil nejednomu gastru, pustil pár slov o Mirandě. No a jak jsme dopadli s jeho novým, parádně
					vymazleným e-shopem a co na nás říkají další vybraní klienti...
				</p>
			</div>
				...
				{!isDesktop && (
					...
					>
						<div
							...
							style={{ position: 'absolute', top: paginationOffset }}
						></div>
						{props.data &&
									...
									<SwiperSlide key={index}>
										<div className='item'>
											<div className='columns col-4-6 align-center'>
												<div className={`column ${styles.image}`} ref={mobileImage}>
													<FetchedImage image={item.attributes.obrazek} />
												</div>
												<div className={`column ${styles.texts}`}>
													<div className='text-center'>
														<a href='#' onClick={toggleText} className='btn btn-secondary'>
															Přečíst celé
														</a>
													</div>
