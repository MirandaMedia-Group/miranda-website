          ...
          <div className={`${styles.container}`}>
            ...
            <div className={`col-4 ${styles.sluzby}`}>
              ...
              <div className={styles.partneri}>
                <h4>Partneři</h4>
                <div>
                  <Image src="/img/icon/google-partner.svg" width={60} height={44} alt=""></Image>
                  <Image src="/img/icon/shoptet-partner.svg" width={113} height={37} alt=""></Image>
                  <Image src="/img/icon/shoptet-premium.svg" width={58} height={58} alt=""></Image>
                  <Image src="/img/icon/sklik.svg" width={100} height={49} alt=""></Image>
                  <Image src="/img/icon/heureka.svg" width={63} height={60} alt=""></Image>
                </div>
              </div>
            </div>
