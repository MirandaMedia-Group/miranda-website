	...
	return (
		<>
			{router.pathname != '/e-shopy' &&
				...
				!router.pathname.includes('/kariera/') && (
					...
					<div className={`${styles.container}`}>
						...
						<div
							className={`${styles.acordeon} ${
								strankyVisible && styles.visible
							}`}
						>
							<h4
								onClick={(e) => {
									strankyVisible
										? setStrankyVisible(false)
										: setStrankyVisible(true);
								}}
							>
								Stránky
							</h4>
						...
						<div
							className={`${styles.acordeon} ${
								sluzbyVisible && styles.visible
							}`}
						>
							<h4
								onClick={(e) => {
									sluzbyVisible
										? setSluzbyVisible(false)
										: setSluzbyVisible(true);
								}}
							>
								Služby
							</h4>
						...
						<div className={`col-4 ${styles.sluzby}`}>
							<div
								className={`${styles.partneri} ${
									styles.acordeon
								} ${partneriVisible && styles.visible}`}
							>
								<h4
									onClick={(e) => {
										partneriVisible
											? setPartneriVisible(false)
											: setPartneriVisible(true);
									}}
								>
									Partneři
								</h4>
								<div>
									<div>
										<Image
											src='/img/icon/google-partner.svg'
											width={60}
											height={44}
											alt='Google Partner'
										></Image>
									...
									<div>
										<Image
											src='/img/icon/shoptet-partner.svg'
											width={113}
											height={37}
											alt='Shoptet Partner'
										></Image>
									...
									<div>
										<Image
											src='/img/icon/shoptet-premium.svg'
											width={58}
											height={58}
											alt='Shoptet PREMIUM'
										></Image>
						...
						<div className={styles.footerBottom}>
							...
							<p className={styles.signature}>
								© MirandaMedia Group s.r.o. 2022 | Zpracování
								osobních údajů
							</p>
						</div>
					</div>
