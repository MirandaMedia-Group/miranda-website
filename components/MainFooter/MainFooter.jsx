...
function Footer() {
	...
	return (
		<>
			{router.pathname != '/shoptetnamiru' && router.pathname != '/kontakty' && !router.pathname.includes('/kariera/') && router.pathname != '/sluzby' && (
					...
					<div className={`${styles.container}`}>
						...
						<div className={styles.footerBottom}>
							<div className={styles.socials}>
								<div>
									<a href='mailto:info@mirandamedia.cz' className={styles.mail}>
								...
								<div>
									<a href='tel:+420732264251' className={styles.phone}>
										+420 732 264 251
									</a>
								</div>
							</div>
