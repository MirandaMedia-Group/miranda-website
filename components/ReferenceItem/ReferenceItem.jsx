...
const ReferenceItem = (props) => {
	return (
		<div className={`${styles.item} ${props.isHomepage ? styles.itemHp : ''}`}>
			<FetchedImage image={props.data.attributes.thumbnail} layout='responsive' />
			<div className={styles.logo}>
				<FetchedImage image={props.data.attributes.logo} />
			</div>
