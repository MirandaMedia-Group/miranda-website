...
const ReferenceEpiderma = ({ reference }) => {
	return (
		<>
			<section>
				<ReferenceHead title='EPIDERMA® - holisticky zaměřená kosmetika' image='/img/reference-epiderma.png' url='www.epiderma.cz' />
			</section>
			...
			<section className={`container ${styles.banner}`}>
				<div>
					<Image src='/img/epidermaBanner.jpg' width={1440} height={574} alt='epiderma' priority={true} />
				</div>
				<div className={styles.mobilHide}>
					<Image src='/img/epidermaBannerMobil.jpg' width={335} height={689} alt='epiderma' priority={true} />
				</div>
				<div className={styles.text}>
					<h2>Příběh pokračuje</h2>
					<p>
						Klient Epiderma je pro nás jasným příkladem dobře fungujícího e-shopu, jehož konverzní míra stále vzrůstá a v součinnosti s tím roste i
						velikost celého elektronického obchodu. Jeho jednoznačně nejlepší vizitkou jsou další a další spokojení zákazníci.
					</p>
				</div>
			</section>
