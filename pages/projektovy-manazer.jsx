                ...
                <div className="container-thin">
                    ...
                    <div className={styles.part}>
                        ...
                        <ul className={styles.list}>
                            <li>Řídit projekty v on-line světě a dohlížet na jejich hladký průběh</li>
                            <li><strong>Precizně nastavovat a dodržovat harmonogramy a specifikace projektů </strong></li>
                            <li>Komunikovat dovnitř i ven z firmy na velmi dobré úrovni</li>
                            <li>„Nacítit“ klienta a vnímat jeho potřeby, včas reagovat</li>
                            <li>Rychle se orientovat v různých oborech napříč trhem</li>
                            <li>Připravovat kvalitní zadání, rozdělovat a hlídat plnění úkolů mezi jednotlivými členy týmů (grafici, kopíci, kodéři ad.)</li>
                    ...
                    <div className={styles.part}>
                        <h3>Požadujeme: </h3>
                        <ul className={styles.list}>
                            <li>Perfektní organizační a vyjednávací dovednosti</li>
                            <li>Analytické schopnosti, mapování a vyhodnocování</li>
                            <li><strong>Dobrou znalost projektového řízení</strong></li>
                            <li>Zkušenost s digitálním marketingem a procesy v e-shopu výhodou</li>
                    ...
                    <div className={styles.part}>
                        ...
                        <ul className={styles.list}>
                            ...
                            <li>Účast na různorodých a mnohdy velmi zajímavých projektech napříč trhem včetně TOP značek</li>
                            <li>Pestrou práci a žádný stereotyp</li>
                            <li>Kariérní růst a když budeš dobrý / dobrá – možnost vést v budoucnu vlastní tým projekťáků</li>
