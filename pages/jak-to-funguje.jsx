            ...
            <section>
                <div className="container">
                    ...
                    <div className={styles.cesta}>
                        ...
                        <div className={styles.cestaItem} style={{right: '0', bottom: '32%'}}>
                        ...
                        <div className={styles.cestaItem} style={{left: '50%', bottom: '20%', transform: 'translateX(-50%)'}}>
                        ...
                        <div className={styles.cestaItem} style={{left: '0', bottom: '32%'}}>
